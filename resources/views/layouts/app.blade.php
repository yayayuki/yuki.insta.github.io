        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    {{-- Searh bar. Show it when the user logs in. --}}
                    @auth
                        @if (!request()->is('admin/*'))
        ...
        <main class="py-5">
            <div class="container">
                <div class="row justify-content-center">
                    {{-- Admin Menu (col-3) --}}
                    @if (request()->is('admin/*'))  {{-- is() will verify the incoming request path --}}
                        <div class="col-3">
                            <div class="list-group">
                                ...
                                <a href="{{ route('admin.categories') }}" class="list-group-item {{ request()->is('admin/categories') ? 'active' : '' }}"><i class="fa-solid fa-tags"></i> Categories</a>
                                {{--
                                if-else shorthand
